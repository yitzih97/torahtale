...
- HEBREW LETTERING MUST BE REAL HEBREW: the general "no text" rule above still applies to signs, titles, captions, labels and decorative writing. It does NOT apply to sacred objects that genuinely bear Hebrew — a Sefer Torah or open klaf, the Luchos (Ten Commandments), a mezuzah, tefillin. Where such writing is visible it MUST be REAL, correctly formed letters of the Hebrew aleph-beis, spelling genuine Hebrew words, running RIGHT-TO-LEFT in a proper Hebrew script (STA"M / Ksav Ashuris for a Sefer Torah or Luchos). ABSOLUTELY NEVER invented, garbled, mirrored, upside-down or decorative pseudo-Hebrew; NEVER Latin/English, Greek, Arabic or any other alphabet; NEVER random squiggles or wavy lines standing in for letters. If accurate Hebrew lettering cannot be rendered faithfully, leave the parchment or stone COMPLETELY BLANK instead — a blank Sefer Torah is perfectly acceptable, fake Hebrew is not.
