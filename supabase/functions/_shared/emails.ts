...
export function renderDeliveredEmail(input: DeliveredEmailInput): string {
  ...
  const greeting = first ? `Great news, ${escapeHtml(first)}!` : "Great news!";
