...
export default {
  ...
  category: "gifts",
  keywords: [
    "personalized Jewish gifts for kids",
    "upsherin gift",
    "bar mitzvah gift ideas",
    "Jewish birthday gift",
    "custom Torah book",
  ],
  keyFacts: [
    "A personalized Torah storybook stars the child by name and likeness inside a real parsha — a keepsake rather than a toy.",
    "Best fits: <strong>birthdays</strong>, an <strong>upsherin</strong> (board book, ages 2–4), a <strong>bar or bas mitzvah</strong> (hardcover, built on that child's parsha), and <strong>Yom Tov</strong>.",
    "Available in English, Hebrew and Yiddish, in softcover, hardcover and board-book formats, with an optional matching coloring book.",
    "Every book is written under rabbinical guidance with strict tznius and reviewed by our team before printing.",
  ],
  faq: [
    {
      q: "What is a good Jewish gift for a 3-year-old boy's upsherin?",
      a: "A board book. The thick chipboard pages and rounded safety corners survive a three-year-old's hands, and seeing himself — peyos and all — inside the parsha makes the day's milestone tangible.",
    },
    {
      q: "What should I give for a bar or bas mitzvah?",
      a: "A hardcover book built around the child's own bar or bas mitzvah parsha, with them as the hero. It ties the gift to the simcha itself, and it's something they keep for life.",
    },
    {
  ...
  he: {
    ...
    date: "2 ביולי 2026",
    keyFacts: [
      "ספר תורה מותאם אישית מכניס את הילד — בשמו ובדמותו — לתוך פרשה אמיתית. מזכרת, לא עוד צעצוע.",
      "מתאים במיוחד ל<strong>ימי הולדת</strong>, ל<strong>אפשערן</strong> (ספר קרטון, גילאי 2–4), ל<strong>בר או בת מצווה</strong> (כריכה קשה, סביב הפרשה של הילד) ול<strong>ימים טובים</strong>.",
      "זמין בעברית, באנגלית וביידיש, בכריכה רכה, קשה או ספר קרטון, עם חוברת צביעה תואמת כתוספת.",
      "כל ספר נכתב בליווי רבני ובצניעות מלאה, והצוות שלנו עובר עליו לפני ההדפסה.",
    ],
    faq: [
      {
        q: "מה מתנה טובה לאפשערן של ילד בן שלוש?",
        a: "ספר קרטון. העמודים העבים והפינות המעוגלות שורדים ידיים של בן שלוש, והמפגש עם עצמו — כולל הפאות — בתוך הפרשה הופך את אבן הדרך של היום למוחשית.",
      },
      {
        q: "מה לתת לבר או בת מצווה?",
        a: "ספר בכריכה קשה סביב פרשת בר או בת המצווה של הילד, כשהוא הגיבור. זה קושר את המתנה לשמחה עצמה, וזה נשאר איתו לכל החיים.",
      },
      {
        q: "כמה זמן לוקח להכין ספר מותאם אישית כמתנה?",
        a: "יצירת הספר אורכת כחמש דקות באתר. משלוח רגיל חינם ומגיע תוך 5–7 ימי עסקים; משלוח מהיר (2–3 ימי עסקים) זמין בתוספת, ואנחנו שולחים לכל העולם.",
      },
      {
        q: "אפשר לתת מנוי במקום ספר בודד?",
        a: "כן. מנוי שבועי, חודשי או שנתי שולח ספר פרשה חדש לפי לוח זמנים — כך נבנית לילד ספריית תורה אישית לאורך השנה.",
      },
    ],
    bodyHtml: `
