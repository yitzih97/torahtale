...
const stories = [
  ...
  { title: "The Tower That Fell", titleHe: "המגדל שנפל", portion: "Parshas Noach", child: "Chaya", childPhoto: kidChaya, coverImage: s3Cover, review: "Such a creative way to teach about achdus. My son finally understood why the dor haflagah was punished.", reviewHe: "ניסיתי שנים להסביר לחיה מה זה דור הפלגה, ופתאום דרך הסיפור הזה היא תפסה לבד למה אחדות זה כל כך חשוב. שווה כל שקל.", reviewer: "Racheli K.", location: "Monsey, NY", rating: 5 },
  { title: "Avraham Counts the Stars", titleHe: "אברהם סופר את הכוכבים", portion: "Parshas Lech Lecha", child: "Shmuel", childPhoto: kidShmuel, coverImage: s4Cover, review: "The night sky illustration took our breath away. Our daughter asks to read this one every single night.", reviewHe: "האיור של שמי הלילה פשוט עוצר נשימה. שמואל מבקש שנקרא אותו כל לילה לפני השינה, וסופר את הכוכבים יחד עם אברהם אבינו.", reviewer: "Shira G.", location: "Passaic, NJ", rating: 5 },
  { title: "Yosef's Coat of Colors", titleHe: "כתונת הפסים של יוסף", portion: "Parshas Vayeishev", child: "Esther", childPhoto: kidEsther, coverImage: s5Cover, review: "The colors are magnificent! My son wears his own 'Yosef coat' now while we read. Pure magic.", reviewHe: "הצבעים פשוט זוהרים. אסתר שלי כבר ביקשה שנתפור לה כתונת פסים משלה כדי שתוכל ללבוש בזמן הקריאה. ספר שמחזיר את התורה לחיים בבית.", reviewer: "Devorah M.", location: "Crown Heights, NY", rating: 5 },
