...
const stories = [
  ...
  { title: "Yosef's Coat of Colors", titleHe: "כתונת הפסים של יוסף", portion: "Parshas Vayeishev", child: "Yaakov", childPhoto: kidEsther, coverImage: s5Cover, review: "The colors are magnificent! My son wears his own 'Yosef coat' now while we read. Pure magic.", reviewHe: "הצבעים פשוט זוהרים. יעקב שלי כבר ביקש שנתפור לו כתונת פסים משלו כדי שיוכל ללבוש בזמן הקריאה. ספר שמחזיר את התורה לחיים בבית.", reviewer: "Devorah M.", location: "Crown Heights, NY", rating: 5 },
