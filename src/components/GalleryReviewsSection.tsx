...
const stories = [
  { title: "The Wonders of Gan Eden", titleHe: "פלאות גן עדן", portion: "Parshas Bereishis", child: "Rivka", childPhoto: kidRivka, coverImage: s1Cover, review: "My daughter couldn't stop talking about Gan Eden! She felt like she was really there walking with Adam and Chava.", reviewHe: "הבת שלי לא הפסיקה לדבר על גן עדן! היא הרגישה שהיא באמת הולכת שם עם אדם וחוה.", reviewer: "Talia B.", location: "Brooklyn, NY", rating: 5 },
  { title: "Noach's Incredible Teivah", titleHe: "התיבה המדהימה של נח", portion: "Parshas Noach", child: "Yehuda", childPhoto: kidYehuda, coverImage: s2Cover, review: "The animals, the teivah, the keshet — every detail was perfect. Our boys read it every Shabbos afternoon.", reviewHe: "החיות, התיבה, הקשת — כל פרט היה מושלם. הבנים שלנו קוראים את זה כל שבת אחר הצהריים.", reviewer: "Avi R.", location: "Lakewood, NJ", rating: 5 },
  { title: "The Tower That Fell", titleHe: "המגדל שנפל", portion: "Parshas Noach", child: "Chaya", childPhoto: kidChaya, coverImage: s3Cover, review: "Such a creative way to teach about achdus. My son finally understood why the dor haflagah was punished.", reviewHe: "דרך יצירתית כל כך ללמד על אחדות. הבן שלי סוף סוף הבין למה דור הפלגה נענש.", reviewer: "Racheli K.", location: "Monsey, NY", rating: 5 },
  { title: "Avraham Counts the Stars", titleHe: "אברהם סופר את הכוכבים", portion: "Parshas Lech Lecha", child: "Shmuel", childPhoto: kidShmuel, coverImage: s4Cover, review: "The night sky illustration took our breath away. Our daughter asks to read this one every single night.", reviewHe: "האיור של שמי הלילה לקח לנו את הנשימה. הבת שלנו מבקשת לקרוא את זה כל לילה.", reviewer: "Shira G.", location: "Passaic, NJ", rating: 5 },
  { title: "Yosef's Coat of Colors", titleHe: "כתונת הפסים של יוסף", portion: "Parshas Vayeishev", child: "Esther", childPhoto: kidEsther, coverImage: s5Cover, review: "The colors are magnificent! My son wears his own 'Yosef coat' now while we read. Pure magic.", reviewHe: "הצבעים מרהיבים! הבן שלי לובש את 'כתונת היוסף' שלו עכשיו בזמן שאנחנו קוראים. קסם טהור.", reviewer: "Devorah M.", location: "Crown Heights, NY", rating: 5 },
  ...
  { title: "Krias Yam Suf", titleHe: "קריעת ים סוף", portion: "Parshas Beshalach", child: "Devorah", childPhoto: kidDevorah, coverImage: s7Cover, review: "Walking through the split sea with Moshe Rabbeinu — my children were mesmerized. A masterpiece.", reviewHe: "ללכת דרך הים שנבקע עם משה רבינו — הילדים שלי היו מהופנטים. יצירת מופת.", reviewer: "Yosef C.", location: "Far Rockaway, NY", rating: 5 },
