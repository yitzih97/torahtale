export const en = {
  ...
  wizard: {
    ...
    planChoiceSubscriptionTitle: "Torah Journey Subscription",
    planChoiceSubscriptionSubtitle: "A new personalized book every week",
    planChoiceSubscriptionBullets: [
      "Your child is the main character in every story",
      "Weekly Parsha + Holidays + more",
      "Build a growing Torah book collection at home",
      "Delivered as real printed books",
    ] as string[],
    planChoiceSubscriptionMicro: "Most families choose this",
    planChoiceSubscriptionCta: "Start My Child's Torah Journey",
    planChoiceSingleTitle: "Single Custom Book",
    planChoiceSingleSubtitle: "Create one personalized story",
    planChoiceSingleBullets: [
      "One-time custom book",
      "Choose any story from Torah, Neviim, or Kesuvim",
      "No ongoing series",
    ] as string[],
