export const en = {
  ...
  whyUs: {
    ...
    features: [
      ...
      { title: "English, Hebrew & Yiddish", desc: "Read in the language your family loves, with authentic loshon kodesh names throughout." },
    ...
    stats: [
      ...
      { value: 3, suffix: "", label: "Languages - English, Hebrew & Yiddish" },
  ...
  auth: {
    ...
    emailNotConfirmed: "This email hasn't been confirmed yet.",
    emailNotConfirmedNotice: "Your email isn't confirmed yet. We can send a fresh confirmation link to",
  ...
  dash: {
    title: "My Dashboard",
    subtitle: "Welcome back! Manage your family's books.",
    children: "Children",
    ...
    createSefer: "Create My Book",
    view: "View",
    parshaClub: "Parsha Club",
    parshaDesc: "A new personalized Torah tale, delivered weekly based on the current parsha. Subscribe during checkout when ordering your next book!",
    ...
    editChildSubtitle: "Update name, photo, and preferences - all in one place.",
    childName: "Name",
    childNamePlaceholder: "e.g., Avi",
    childGender: "Gender",
    boy: "Boy",
    girl: "Girl",
    childAge: "Age",
    childAgePlaceholder: "e.g., 6",
    childDescription: "Description (optional)",
    childDescriptionPlaceholder: "Brown curly hair, big brown eyes, loves blue...",
    ...
    girlDetail: "Modest dress",
    ageTitle: (name: string) => `How old is ${name}?`,
    ageSubtitle: "Type their age, or tap an age group below.",
    ageInputPlaceholder: "Age",
    photoTitle: (name: string) => `Help us draw ${name}`,
    photoSubtitle: "Upload a photo or describe your child's appearance. Both are optional!",
    uploadPhotoTitle: "Upload a Photo",
    uploadPhotoDesc: "Best results with clear face photos",
    removePhoto: "Remove",
    tipsTitle: "Tips for best results",
    tipFace: "Face clearly visible",
    tipLighting: "Good lighting",
    tipCloseup: "Close-up portrait",
    describeTitle: "Describe Instead",
    describeDesc: "Tell us what your child looks like",
    ...
    book: {
      ...
      reorderFailed: "We couldn't start that order - please try again.",
      afterDelivery: "Available once delivered",
    ...
    settingsPanel: {
      ...
      del: {
        q1Title: "Why are you closing your account?",
        q1Body: "This helps us understand what went wrong. Pick the closest reason:",
        reasons: ["It's too expensive", "I didn't use it enough", "I wasn't happy with the books", "I had a problem with an order", "Just taking a break", "Something else"],
        detailPlaceholder: "Anything else you'd like to tell us? (optional)",
        q2Title: "Are you sure? This can't be undone.",
        q2Body: "Your profile, your kids' details and your saved plans will be permanently deleted. Books you already ordered stay in our records for order history, but you will lose access to them here. This cannot be reversed.",
        typeToConfirm: "Type DELETE to confirm",
        stepOf: (n: number) => `Step ${n} of 2`,
        next: "Continue", back: "Go back", confirmBtn: "Delete my account",
        blocked: (n: number) => `You still have ${n === 1 ? "an active plan" : `${n} active plans`}. Cancel ${n === 1 ? "it" : "them"} first - otherwise you would keep being billed for an account that no longer exists.`,
        blockedToast: "Cancel your active plan first.",
        done: "Your account has been deleted.",
        failed: "Couldn't delete the account - please try again or contact us.",
      },
    },
    // Book viewer modal
    viewer: {
    ...
    manage: {
      ...
      updateCard: "Email me a link", cardSecureNote: "Card details can never be entered on our site. Tap above and Shopify emails you a secure link to change the card.",
      cardEmailSent: "Secure link sent - check your email.",
      cardEmailNote: (email: string) => `We've emailed${email ? ` ${email}` : ""} a secure link from Shopify to change the card. Card details are entered there, never on our site.`,
      cancelYes: "Yes, cancel it", cancelNo: "Keep my plan",
  ...
  about: {
    ...
    ctaDesc: "Join thousands of families who are making Torah learning personal, memorable, and joyful.",
  ...
  wizard: {
    ...
    weeklyParshaDefault: "Start with this week's Parsha",
    ...
    exitSave: "Save & exit",
    exitSaveFailed: "We couldn't save your progress on this device. Keep editing and finish your book, or discard it on purpose.",
    ...
    photoAdjust: "Zoom in on the face",
    photoZoomTip: "For the best likeness, zoom in so the face fills the circle. Tap to adjust.",
    ...
    weeklyParsha: "Weekly Parsha",
    weeklyParshaDesc: "Automatically get next week's parsha - perfect for Shabbos prep!",
    parshaAndHolidays: "Parsha & Holidays",
    ...
    emailNotConfirmed: "This email hasn't been confirmed yet - resend the link below.",
    ...
    emailPreviewMsg: (names: string) => `Our team reviews every book before printing - you'll get a quick peek of ${names}'s book by email when it ships.`,
  ...
  shipping: {
    ...
    standard: "Standard",
    express: "Express",
    businessDays: (range: string) => `${range} business days`,
  ...
  checkout: {
    ...
    shippingOneDelivery: "Shipping (one delivery)",
    plan: "Plan",
    ...
    coverUseThis: "Use this cover",
    coverSaveFailed: "We couldn't save that cover. Please try again.",
    coverSaved: "Saved as your book's character",
    coverSavedNote: "Your child will be drawn as this character on every page.",
    coverRetakeHint: "Out of tries. A clearer, front-facing photo usually fixes it - add a new one and we'll create a fresh cover, with two more tries.",
    coverNewPhotoFor: (name: string) => `New photo for ${name}`,
    ...
    fourBooksMonth: "4 books a month - a new book every week",
    saveAmount: (amount: string) => `Save ${amount} a year vs paying monthly`,
    ...
    subscribeOrder: (total: string) => `Proceed to Checkout - $${total}`,
    placeOrder: (total: string) => `Proceed to Checkout - $${total}`,
    subscribeOrderShort: "Proceed to Checkout",
    placeOrderShort: "Proceed to Checkout",
    ...
    switchToYearly: "Switch to yearly", payYearlySave: "Pay once for the whole year and save vs monthly",
  ...
  upsell: {
    ...
    joinTitle: "Join the Parsha Club",
    ...
    subscribe: "Subscribe",
    freeShipCancel: "🚚 4 books a month in one delivery · Cancel anytime · Secure checkout",
    ...
    freeShipCancelShort: "🚚 4 books a month in one delivery · Cancel anytime",
  ...
  faq: {
    ...
    items: [
      ...
      { category: "books", question: "How many pages are in each book?", answer: "Each book has 10 beautifully illustrated story pages, plus a personalized cover and a fun review-questions page at the end." },
      { category: "books", question: "What do the illustrations look like?", answer: "Every Torah Tale is illustrated in a warm, ultra high-resolution 3D Pixar style - rich, movie-quality scenes with cinematic lighting, and your child rendered consistently on every page." },
      { category: "books", question: "What book formats are available?", answer: "A softcover photo book (8″×8″), a premium hardcover photo book (8″×8″, in square or landscape), and a sturdy 6″×6″ board book for little hands. You can also add a matching 8.5″×11″ coloring book of the same story." },
      { category: "books", question: "What languages are available?", answer: "Every book can be created in English, Hebrew, or Yiddish - and you can order the same story in more than one language." },
      { category: "books", question: "Can I see the book before it's printed?", answer: "Every book is personally reviewed and quality-checked by our team before it goes to print, so you don't need to. You'll receive a quick peek of your book by email as soon as it ships - and the full keepsake arrives at your door." },
      ...
      { category: "billing", question: "How does the subscription work?", answer: "Choose the Parsha Series - 4 books a month, aligned with the weekly parsha and Yomim Tovim, shipped together in one delivery - or a Year Bundle with two months free. You can cancel anytime from My Dashboard." },
      { category: "customization", question: "Can I customize my child's appearance?", answer: "Yes! Upload one clear, front-facing photo and we create an illustrated character that looks just like your child on every page. You can add up to eight siblings to the same book - with a big family, each page stars a few of them in turn, so every child gets their moments." },
      { category: "customization", question: "Can I choose which parsha to use?", answer: "Yes - this week's parsha is selected automatically (perfect for Shabbos prep), or browse the full Tanach: Chumash, Nevi'im, Kesuvim, Megillos, and Yamim Tovim stories. On double-parsha weeks, one book covers both." },
      ...
      { category: "returns", question: "What if I'm not happy with the illustrations?", answer: "Our team reviews and fine-tunes every book before it's printed. If your printed book still isn't right, contact us at help@torahtale.com and we'll work with you to make it right." },
    ],
  },
  ...
  collectionRequest: {
    ...
    childAge: (age: string) => `${age} years old`,
    photoLabel: "Photo",
    backHome: "Back home",
  ...
  pricing: {
    ...
    collBestValue: "Best value",
    collAdd: "Add to cart",
    collAdded: "Added",
    collEmpty: "Choose one or more collections above to add them to your cart.",
    collSwapTitle: "The Complete Collection has all of these for less.",
    collSwapSave: (amount: string) => `Switch and save ${amount}.`,
    collSummary: (count: number, books: number) =>
      `${count === 1 ? "1 collection" : `${count} collections`} · ${books} books`,
    collCheckout: "Checkout",
    collRequest: "Request these collections",
    collFootnote:
