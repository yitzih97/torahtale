export const en = {
  ...
  faq: {
    ...
    items: [
      ...
      { category: "general", question: "Are the stories accurate to the Torah?", answer: "Yes! Every story is carefully crafted with rabbinical guidance to stay true to the parashah, with tznius-mindful illustrations and a clear middos lesson — engaging and age-appropriate for children." },
      ...
      { category: "customization", question: "Can I choose which parashah to use?", answer: "Yes — this week's parashah is selected automatically (perfect for Shabbos prep), or browse the full Tanach: Chumash, Nevi'im, Kesuvim, Megillos, and Yamim Tovim stories. On double-parsha weeks, one book covers both." },
