export const en = {
  ...
  faq: {
    ...
    items: [
      ...
      { category: "customization", question: "Can I customize my child's appearance?", answer: "Yes! Upload one clear, front-facing photo and we create an illustrated character that looks just like your child on every page. You can even add up to four siblings to the same book." },
