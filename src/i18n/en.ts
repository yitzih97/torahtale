export const en = {
  ...
  faq: {
    ...
    items: [
      ...
      { category: "billing", question: "How does the subscription work?", answer: "Choose Weekly (a new parsha book every week), Monthly (4 books a month, aligned with the weekly parsha and Yomim Tovim), or a Year Bundle with two months free. You can cancel anytime from My Dashboard." },
