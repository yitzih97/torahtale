export const en = {
  ...
  faq: {
    ...
    items: [
      ...
      { category: "books", question: "What art styles are available?", answer: "We offer three illustration styles — Cartoon, 3D Pixar, and Realistic. During creation you'll even see your own child previewed in each style before you choose." },
