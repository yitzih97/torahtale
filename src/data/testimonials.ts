...
export const TESTIMONIALS: Testimonial[] = [
  ...
  { name: "Rivky Weinberg", location: "Monsey, NY", text: "The illustrations are stunning and completely tznius - peyos, tzitzis, everything just right. The Rosh Hashanah book captured the whole story perfectly.", rating: 5 },
  { name: "Shaindy Klein", location: "Boro Park, NY", text: "My son didn't believe it was really him in the sefer until he saw his own face decorating the sukkah. He hasn't stopped showing his rebbi.", rating: 5 },
  ...
  { name: "Yossi Adler", location: "Baltimore, MD", text: "The Dovid and Golias book had my three-year-old cheering out loud. He carries it around like a shield. Incredible.", rating: 5 },
  ...
  { name: "Menachem Pollak", location: "Los Angeles, CA", text: "As a rebbi I check everything my talmidim bring home. The content here is authentic and respectful - I now recommend it to all my talmidim's parents.", rating: 5 },
  ...
  { name: "Ari Schwartz", location: "Teaneck, NJ", text: "Beautiful values woven into every page. The tzedakah story had my daughter emptying her own pushke without being asked.", rating: 4 },
  ...
  { name: "Naftali Gross", location: "Lakewood, NJ", text: "The Yonah page with the great fish rising out of the water is breathtaking. We framed a print of it for the kids' room.", rating: 5 },
  ...
  { name: "Moshe Davidson", location: "Houston, TX", text: "Living out of town, this brings so much Yiddishkeit into our home. The Yom Tov books mean my kids come to every seder and sukkah already excited.", rating: 5 },
  ...
  { name: "Eli Kaplan", location: "Detroit, MI", text: "The Daniel in the lions' den edition is so vivid. The light practically glows off the page. Stunning craftsmanship.", rating: 5 },
  ...
  { name: "Shimon Erlich", location: "Toronto, ON", text: "The Megillas Rus book about loyalty and chesed is gentle and tasteful. My daughter asks for it every Shavuos.", rating: 5 },
  ...
  { name: "Avrohom Weiss", location: "Chicago, IL", text: "The whole process was simple even for someone not so techy. Uploaded a photo, picked a story, done.", rating: 4 },
  ...
  { name: "Dov Ber Klein", location: "Monsey, NY", text: "Three kids, three books, three different parshiyos - and each one looks exactly like the child. Unreal.", rating: 5 },
  ...
  { name: "Meir Landau", location: "Baltimore, MD", text: "I teach pre-1A and parents keep asking where I got 'that personalized middos book.' This one. Always this one.", rating: 5 },
